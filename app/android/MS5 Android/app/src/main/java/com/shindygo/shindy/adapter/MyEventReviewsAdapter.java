...
public class MyEventReviewsAdapter extends RecyclerView.Adapter<MyEventReviewsAdapter.MyViewHolder> {
    ...
    public MyEventReviewsAdapter(List<EventInvite> mValues, Context context, Click<EventInvite> click) {
    ...
    @Override
    public MyEventReviewsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyEventReviewsAdapter.MyViewHolder(
                LayoutInflater.from(context).inflate(R.layout.item_event_reviews,null));
    }

    @Override
    public void onBindViewHolder(final MyEventReviewsAdapter.MyViewHolder holder, final int position) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View v) {
            ...
            tvQuickReview = v.findViewById(R.id.tv_quick_review);
