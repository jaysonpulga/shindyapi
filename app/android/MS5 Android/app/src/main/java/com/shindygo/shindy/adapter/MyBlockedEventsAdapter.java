...
public class MyBlockedEventsAdapter extends RecyclerView.Adapter<MyBlockedEventsAdapter.ViewHolder> {
    private final List<EventInvite> mValues;


    //  private  List<EventInvite> mValues = new ArrayList<>();
    private static final String TAG = MyBlockedEventsAdapter.class.getSimpleName();
    ...
    public MyBlockedEventsAdapter(List<EventInvite> mValues, Context context, Click<EventInvite> click) {
    ...
    public MyBlockedEventsAdapter(List<EventInvite> items) {
        mValues = items;
    }

    @Override
    public MyBlockedEventsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_blocked_events, parent, false);
        return new MyBlockedEventsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final MyBlockedEventsAdapter.ViewHolder holder, int position) {
