...
import com.shindygo.shindy.LikedEventsFragment.OnListFragmentInteractionListener;
...
public class MyLikedEventsAdapter extends RecyclerView.Adapter<MyLikedEventsAdapter.ViewHolder> {
    ...
    public MyLikedEventsAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
