...
import com.shindygo.shindy.main.model.NewUser;
import com.shindygo.shindy.model.User;

public class NewUserCardAdapter extends ArrayAdapter<User> {
    ClickCard clickCard;
    ClickShowPopup clickShowPopup;
    public NewUserCardAdapter(Context context, ClickCard clickCard, ClickShowPopup clickShowPopup) {
        super(context, 0);
    ...
    private static class ViewHolder {
        ...
        ivCheck.setOnClickListener(new View.OnClickListener() {
            ...
            ivPreview.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    clickShowPopup.Show(view.getTag());
                }
            });
        }
    }
